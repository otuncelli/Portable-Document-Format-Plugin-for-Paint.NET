...
namespace PaintDotNet.IndirectUI
{
    internal static class PropertyControlInfoExtensions
    {
        ...
        /// <see cref="StaticListChoiceProperty" />
        /// </remarks>
        public static PropertyControlInfo ValueDisplayName<T>(this PropertyControlInfo pci, T value, string displayName)
        ...
        {
            if (!(pci.Property is StaticListChoiceProperty property))
            {
