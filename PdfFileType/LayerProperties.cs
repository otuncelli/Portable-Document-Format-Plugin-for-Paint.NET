...
internal sealed class LayerProperties(string name, bool visible, bool isBackground, byte opacity, LayerBlendMode blendMode)
{
    ...
    public static bool TryLoadFromPageObjectMark(in FPDF_PAGEOBJECTMARK mark, byte[] buf, [NotNullWhen(true)] out LayerProperties? props)
    {
        try
        {
