...
#pragma warning restore format // @formatter:on
    ...
    protected IReadOnlyList<BitmapLayer> GetFilteredLayers()
    {
        if (Mode == ExportMode.Flattened)
        {
            ...
            return [new BitmapLayer(ScratchSurface, takeOwnership: false)];
        }
    ...
    protected static MemoryStream EncodeLossless(Bitmap bmp)
    {
        MemoryStream ms = new MemoryStream();
...
#pragma warning restore IDE0004
    ...
    {
        public static readonly BitmapLayerEqualityComparer Instance = new();
        ...
        public int GetHashCode(BitmapLayer obj)
        {
            return GetPixelDataHash(obj.Surface);
        }
